...
class ShoeAdmin(admin.ModelAdmin):
    list_display = ("brand", "model_name", "nickname", "shoe_mileage", "user", "date_added", "is_retired")
    list_filter = ("user", "brand", "model_name")

@admin.register(Block)
class BlockAdmin(admin.ModelAdmin):
    list_display = ("name", "user", "block_mileage", "start", "end")
    list_filter = ("user", "name")


@admin.register(Cycle)
class CycleAdmin(admin.ModelAdmin):
    list_display = ("start", "end", "cycle_mileage", "user")
    list_filter = ("user", "start", "end")


@admin.register(Activity)
class ActivityAdmin(admin.ModelAdmin):
    list_display = ("title", "user", "timestamp", "activity_mileage", "perceived_effort")
